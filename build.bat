...
scons platform=windows target=editor steamapi=yes extra_suffix="rframework" module_mono_enabled=yes -j8
...
python modules/mono/build_scripts/build_assemblies.py --godot-output-dir=./bin --godot-platform=windows --push-nupkgs-local modules/mono/glue/GodotSharp